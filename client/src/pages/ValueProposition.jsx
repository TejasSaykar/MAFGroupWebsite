  ...
  return (
    <Layout title={"MAF | Value Proposition"}>
      <div className="mt-[4rem] w-full">
        <div className="relative w-full h-screen md:h-[67vh] top">
          <img
          ...
          <div class="absolute flex-col mt-20 gap-8 px-5 w-full inset-0 bottom-0 flex md:flex-row items-center md:justify-between text-white md:px-16">
            <div className="left w-full text-center md:text-start md:w-[50%]">
              <h2
                className="text-3xl md:text-5xl font-bold mt-5 md:mt-40 cursor-pointer"
            ...
            <div className="right w-full text-center md:text-start md:w-[40%]">
              <p className="hover text-lg md:text-2xl font-light cursor-pointer hover:drop-shadow-xl drop-shadow-md">
        ...
        <div className="w-full mt-8 md:mt-20">
          <div className="flex-col px-5 md:px-14 md:flex-row flex gap-5 w-full">
            <div className="left w-full my-auto">
              <img
            ...
            <div className="right w-full flex flex-col gap-2 md:gap-5 h-auto my-auto">
              <h1
                style={{ fontFamily: "sans-serif" }}
                className="text-2xl md:text-4xl text-[#071b52] dark:text-rose-600 font-bold"
              >
                Diverse Footprint
              </h1>
          ...
          <div className="flex-col px-5 md:px-14 md:flex-row flex gap-5 w-full">
            <div className="left w-full order-1 md:order-2">
              <img
                src="/img/agile.png"
                alt=""
                className="w-full my-auto aspect-video object-cover"
              />
            </div>
            <div className="right w-full flex flex-col gap-2 md:gap-5 h-auto my-auto order-2 md:order-1">
              <h1
                style={{ fontFamily: "sans-serif" }}
                className="text-2xl md:text-4xl text-[#071b52] dark:text-rose-600 font-bold"
              >
          ...
          <div className="flex-col px-5 md:px-14 md:flex-row flex gap-5 w-full">
            <div className="left w-full order-1">
              <img
                src="/img/partner.png"
                alt=""
                className="w-full aspect-video object-cover my-auto"
              />
            </div>
            <div className="right w-full flex flex-col gap-2 md:gap-5 h-auto my-auto order-2">
              <h1
                style={{ fontFamily: "sans-serif" }}
                className="text-2xl md:text-4xl text-[#071b52] dark:text-rose-600 font-bold"
              >
