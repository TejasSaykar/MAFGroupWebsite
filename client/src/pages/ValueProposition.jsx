    ...
    <Layout title={"MAF | Value Proposition"}>
      <div className="mt-[4rem] w-full">
        ...
        <div className="bg-[#f8f9fa]">
          <div className="">
            <div className="w-full pt-10 md:w-[90%] mx-auto">
              <div className="flex-col px-5 md:px-14 md:flex-row gap-5 items-center flex w-full">
                ...
                <div className="right w-full flex flex-col h-auto">
                  ...
                  <p className="text-justify font-light">
                    ...
                    customers and accumulate a global footprint that spans
                    across 70 countries. With dual headquarters in India and UK,
                    we have ventured into various industries such as Retail,
                    Ecommerce and have embarked on multiple challenging projects
                    thus emerging successful.
                  </p>
                </div>
              </div>
            </div>

            <div className="w-full pb-10 pt-2 md:pt-8 my-5 bg-[#eb1c26]">
              <div className="w-full mt-10 md:mt-8 md:w-[90%] mx-auto">
                <div className="flex-col px-5 md:px-14 md:flex-row flex items-center gap-5 w-full">
                  ...
                  <div className="right w-full flex flex-col h-auto order-2 md:order-1">
                    <h1
                      style={{ fontFamily: "sans-serif" }}
                      className="text-2xl text-gray-800 mb-2 dark:text-rose-600 font-bold"
                    >
                      Agile Development
                    </h1>
                    <p className="text-justify text-white font-light">
                      We expediate your journey to success by adapting an
                      iterative approach to ensure rapid results thus helping
                      you stay ahead of the curve. We commit ourselves to
                      achieving adaptability and efficiency in this dynamic
                      business landscape.
                    </p>
                  </div>
                </div>
            ...
            <div className="w-full">
              <div className="w-full mt-5 pb-10 md:mt-8 md:w-[90%] mx-auto">
                <div className="flex-col px-5 md:px-14 md:flex-row items-center flex gap-5 w-full">
                  ...
                  <div className="right w-full flex flex-col h-auto order-2 md:order-1">
                    ...
                    <p className="text-justify font-light">
                      ...
                      requirements and craft business plans that assure
                      sustained growth and resilience in the face of changing
                      objectives. Our solutions are effective in the test of
                      time as it is crafted by understanding your unique needs.
                    </p>
                  </div>
                </div>
              </div>
