    ...
    <>
      ...
      >
          ...
          <div className="relative w-[70%] m-auto px-10">
            ...
            <div className="bottom w-full flex gap-4 items-srart justify-center">
              <div className="left w-full">
                ...
                <h2 className="text-xl font-bold hover:underline mt-2 mb-5 text-[#071b52]">
                  Going hyperlocal in India
                </h2>
                <p className="text-gray-600">
                  India is a vast country, and advertising that works in one
                  part of the country may not work well in another.
                </p>
              </div>
              <div className="middle w-full">
                ...
                <p className="text-gray-600">
                  Both the accolades and the ideas associated with WPP’s use of
                  technologies that underpin the metaverse stand out in India
                </p>
              </div>
              <div className="right w-full">
                ...
                <p className="text-gray-600">
                  The modern B2B CMO must act as a tech integrator, customer
                  oracle and cross-department orchestrator, says Kristin Gower
                  of WPP’s EssenceMediacom
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full mt-20">
          ...
          <div className="w-[66%] m-auto mt-0 pl-6">
            <h3 className="text-xl font-semibold my-4 text-[#071b52]">
        ...
        <div className="w-full mt-20">
          <div className="relative w-[70%] m-auto px-4 flex gap-4 justify-center items-start">
            <h2 className="absolute -left-16 top-16 font-bold text-xl -rotate-90 text-[#071b52]">
              LATEST NEWS
            </h2>
            <span className="absolute right-5 -top-8 flex gap-2 items-center">
              <FaArrowRight className="text-sky-500" />
              <h2 className="text-gray-500 font-semibold hover:underline cursor-pointer">
                Read more news
              </h2>
            </span>
            <div className="one w-full">
              <img
                src="/img/last1.jpg"
                className="h-auto w-full bg-cover bg-center object-cover aspect-square"
                alt=""
              />
              <h2 className="text-xl font-bold my-3 hover:underline text-[#071b52]">
            ...
            <div className="two w-full">
              <img
                src="/img/last2.jpeg"
                className="h-auto w-full bg-contain object-cover bg-center aspect-square"
                alt=""
              />
              <h2 className="text-xl font-bold my-3 hover:underline text-[#071b52]">
        ...
        <div className="w-full mt-20 gradiant text-white py-10">
          <div className="relative w-[70%] m-auto flex gap-4 justify-center items-start">
            <h2 className="absolute -rotate-90 -left-24 top-14 text-xl font-bold">
              INVESTORS
            </h2>
