      ...
      <div className="w-full mt-[4rem]">
        <div className="relative w-full h-[70vh]">
          ...
          <div className="absolute inset-0 w-full flex justify-center items-center">
            <h1 className="text-5xl font-bold text-white">Manufacturing</h1>
          </div>
        </div>
        ...
        <div className="w-full mt-10">
          <div className="w-[70%] m-auto flex flex-col gap-5 text-xl font-light">
            <p>
              ...
              guiding them through the intricacies of this digital era and the
              manufacturing industry has been one of them as well. We have been
              a reliable partner in this ever-evolving domain by bringing to the
              table our knowledge of problems unique to this industry and our
              need to deeply understand our client’s problems.
            </p>
            <p>
              ...
              empower you with everything you need to build a thriving business.
            </p>
            <p>
