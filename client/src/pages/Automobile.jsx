      ...
      <div className="mt-[4rem] w-full">
        <div className="relative w-full h-[70vh]">
          ...
          <div className="absolute w-full inset-0 flex items-center justify-center">
            <h2 className="text-6xl font-bold text-white">Automobile</h2>
          </div>
        </div>
        <div className="w-full mt-10">
          <div className="w-[80%] m-auto flex flex-col gap-5">
            <p className="text-xl font-light">
              The landscape of the automobile industry is evolving, fuelled by
              the changing circumstances which include technological
              advancements, customer preference changes and emergence of
              innovative trends. Keeping yourself in pace with this dynamic
              world is next to impossible on top of building a business. Despite
              all of this, staying ahead of the competition and distinguishing
              yourself is a non-negotiable factor.{" "}
            </p>
            <p className="text-xl font-light">
              Aligning with the industry trends alone cannot guarantee you
              standing out in the industry, personalization and trend setting
              strategies are what will assure your unparalleled success.
            </p>
            <p className="text-xl font-light">
