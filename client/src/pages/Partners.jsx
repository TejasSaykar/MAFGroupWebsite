  ...
  return (
    <Layout title={"MAF | Partners"}>
      <div className="mt-[4rem] w-full">
        ...
        <div className="w-[90%] lg:w-[60%] m-auto flex h-[90%] flex-col justify-center items-start gap-5">
          <h1 className="text-4xl text-center pt-5 font-bold text-[#071b52] dark:text-rose-600">
            Our Partners
          </h1>
